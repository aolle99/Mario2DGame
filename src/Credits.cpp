...
void Credits::initBackground() {
	spritesheetBackground.loadFromFile("res/images/credits.png", TEXTURE_PIXEL_FORMAT_RGBA);
...
void Credits::hover(int which, bool isHover) {

}

void Credits::clicked(int which) {
	switch (which)
	{
	case 0:
		if (currentScreen != 1)
